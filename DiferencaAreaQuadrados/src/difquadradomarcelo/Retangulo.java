...
public class Retangulo {
    ...
    public boolean quadrados(int x, int y)
    {
    ...
    {
        int points = 0; 
        if(quadrados(retangulo.getX1(), retangulo.getY1()))
        {
            points++;
        }

        if(quadrados(retangulo.getX1(), retangulo.getY2()))
        {
            points++;
        }

        if(quadrados(retangulo.getX2(), retangulo.getY1()))
        {
            points++;
        }

        if(quadrados(retangulo.getX2(), retangulo.getY2()))
        {
            points++;
        }
        return (points == 4);
